...
const config = {
    serverInfo: {
        ...
        serverIp: "IN ARRIVO...", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        ...
        SrHelper: [
            {
                inGameName: "𝓟𝓲𝓸𝔁",
                rank: "Sr.Helper",
                skinUrlOrPathToFile: "images/piox.png",
                rankColor: "#196300"
            },
            {
                inGameName: "",
        ...
        helpers: [
            {
                inGameName: "𝓞𝓼𝓬𝓪𝓻",
                rank: "Helper",
                skinUrlOrPathToFile: "images/oscargay.png",
                rankColor: "Green"
            },
            {
                inGameName: "𝓐𝓵𝓮𝔁",
